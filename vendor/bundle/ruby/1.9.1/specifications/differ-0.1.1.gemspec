...
Gem::Specification.new do |s|
  ...
  s.files = ["README.rdoc", "VERSION.yml", "lib/differ/change.rb", "lib/differ/diff.rb", "lib/differ/format/ascii.rb", "lib/differ/format/color.rb", "lib/differ/format/html.rb", "lib/differ/string.rb", "lib/differ.rb", "spec/differ/change_spec.rb", "spec/differ/diff_spec.rb", "spec/differ/format/ascii_spec.rb", "spec/differ/format/color_spec.rb", "spec/differ/format/html_spec.rb", "spec/differ/string_spec.rb", "spec/differ_spec.rb", "spec/spec_helper.rb"]
